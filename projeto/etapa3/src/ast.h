 ...
 * Cada nó representa uma construção da linguagem LC-: expressão, comando,
 ...
 *
 * NOTA SOBRE LISTAS:
 *   Em LC-, sempre que a gramática admite uma lista (lista de comandos,
 ...
 * construções de LC-. Nós com aridade variável usam o campo 'next'. */
